...
import { workExp, IWorkExp} from "../../data";
      ...
      {[...workExp].reverse().map((work: IWorkExp, index) => (
        ...
        >
          <section className="flex justify-start items-center">
            ...
            <Link className="flex items-center justify-start" to={work.link} target="_blank">
          ...
          <section className="pl-5 py-4 text-base text-white-100 pb-10 mb-4 border-b-2 border-grey-100">
            ...
            <ul>
              {work.work.map((w,index) => (
                <li key={index} className=" list-disc ml-5 text-white-400">{w}</li>
              ))}
            </ul>
          </section>
        </section>
